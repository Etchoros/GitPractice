...
public class _43ManageCodeTable_AddCode {
	...
	public void test() throws InterruptedException {
		...
		driver.findElement(By.xpath("//*[@id='name']")).sendKeys("Test Code");
		driver.findElement(By.xpath("//*[@id='code']")).sendKeys("Seleniumxxx");
		driver.findElement(By.xpath("//*[@id='description']")).sendKeys("Start Testing");
		driver.findElement(By.xpath("//*[@id='comment']")).sendKeys("Pass or NOt");
