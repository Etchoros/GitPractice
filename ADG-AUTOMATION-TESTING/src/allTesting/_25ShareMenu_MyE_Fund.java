...
public class _25ShareMenu_MyE_Fund {
	...
	public void test() throws InterruptedException {
		 ...
		 * 
		 */
		WebElement SharesMenu = driver.findElement(By.linkText("Shares"));
		Actions action = new Actions(driver);
		action.moveToElement(SharesMenu).perform();
		Thread.sleep(2000);

		WebElement MyE_Fund = driver.findElement(By.linkText("My E-Fund"));
		action.moveToElement(MyE_Fund).click().perform();
	}
	@After
