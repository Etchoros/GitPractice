...
public class _31TradeMenu_AllMemberOpenTrades {
	...
	public void test() throws InterruptedException {
		...
		WebElement MyOpenTrades = driver.findElement(By.linkText("My Open Trades"));
		action.moveToElement(MyOpenTrades).click().perform();
	}
	@After
