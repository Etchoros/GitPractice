...
public class _48MainMenu_TradeSettings {
		...
		public void test() throws InterruptedException {
			...
			WebElement TableSettings = driver.findElement(By.linkText("Table Settings"));
			action.moveToElement(TableSettings).click().perform();
