...
public class _11MemberMenu_ResetMemberPassword {
	...
	public void test() throws InterruptedException {
		...
		/**
		 * This part is click on "Referrals Tree View" under MenuBar
		 * 
		 */
		...
		WebElement BinaryLrTreeView = driver.findElement(By.linkText("Binary LR Tree View"));
		action.moveToElement(BinaryLrTreeView).click().perform();

		/**
		 * This part is for check Binary LR Tree View function"
		 */
