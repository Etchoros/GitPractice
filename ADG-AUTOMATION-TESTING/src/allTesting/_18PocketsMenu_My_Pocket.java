...
public class _18PocketsMenu_My_Pocket {
	...
	public void test() throws InterruptedException {
		...
		WebElement My_PocketsList = driver.findElement(By.linkText("My Pockets"));
		action.moveToElement(My_PocketsList).click().perform();
	}
