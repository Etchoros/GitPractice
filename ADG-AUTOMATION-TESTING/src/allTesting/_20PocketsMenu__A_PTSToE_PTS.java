...
public class _20PocketsMenu__A_PTSToE_PTS {
	...
	public void test() throws InterruptedException {
		...
		WebElement A_PTSToE_PTS = driver.findElement(By.linkText("Transfer A-PTS/E-PTS"));
		action.moveToElement(A_PTSToE_PTS).click().perform();
		//No place to put information and update
	}
