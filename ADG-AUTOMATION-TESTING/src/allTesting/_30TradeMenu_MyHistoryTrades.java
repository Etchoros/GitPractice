...
public class _30TradeMenu_MyHistoryTrades {
	...
	public void test() throws InterruptedException {
		...
		WebElement MyHistoryTrades = driver.findElement(By.linkText("My History Trades"));
		action.moveToElement(MyHistoryTrades).click().perform();
	}
	@After
