...
public class _06MembersMenu_ReferredMembers {
		...
		public void test() throws InterruptedException {
			...
			/**
			 * This part is click on "Referred Members" under MenuBar
			 * 
			 */
			...
			WebElement ReferredMembers = driver.findElement(By.linkText("Referred Members"));
			action.moveToElement(ReferredMembers).click().perform();
		}
