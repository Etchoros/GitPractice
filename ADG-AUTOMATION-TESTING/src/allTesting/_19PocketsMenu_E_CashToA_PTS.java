...
public class _19PocketsMenu_E_CashToA_PTS {
	...
	public void test() throws InterruptedException {
		...
		WebElement E_CashToA_PTS = driver.findElement(By.linkText("E-Cash to A-PTS"));
		action.moveToElement(E_CashToA_PTS).click().perform();
