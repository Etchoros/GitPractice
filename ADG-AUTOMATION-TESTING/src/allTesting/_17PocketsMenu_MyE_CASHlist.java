...
public class _17PocketsMenu_MyE_CASHlist {
	...
	public void test() throws InterruptedException {
		...
		WebElement MyE_CASHlist = driver.findElement(By.linkText("My E-CASH"));
		action.moveToElement(MyE_CASHlist).click().perform();
	}
