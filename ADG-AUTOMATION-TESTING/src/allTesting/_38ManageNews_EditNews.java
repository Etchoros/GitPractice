...
public class _38ManageNews_EditNews {
	...
	public void test() throws InterruptedException {
		...
		driver.findElement(By.id("newsDate")).sendKeys("10/18/2017 12:30");
		driver.findElement(By.id("heading")).sendKeys("Hello");
		driver.findElement(By.id("subtitle")).sendKeys("Hellooo");
		driver.findElement(By.id("detail")).sendKeys("hellllo");
