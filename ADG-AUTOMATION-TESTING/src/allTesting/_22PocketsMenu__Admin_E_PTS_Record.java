...
public class _22PocketsMenu__Admin_E_PTS_Record {
	...
	public void test() throws InterruptedException {
		...
		WebElement Admin_E_PTS_Record = driver.findElement(By.linkText("Admin E-PTS Records"));
		action.moveToElement(Admin_E_PTS_Record).click().perform();
