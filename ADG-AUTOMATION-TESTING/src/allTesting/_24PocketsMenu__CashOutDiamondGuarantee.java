...
public class _24PocketsMenu__CashOutDiamondGuarantee {
	...
	public void test() throws InterruptedException {
		...
		WebElement CashOutDiamondGuarantee = driver.findElement(By.linkText("Cash Out Diamond Guarantee"));
		action.moveToElement(CashOutDiamondGuarantee).click().perform();
//can't locate		
