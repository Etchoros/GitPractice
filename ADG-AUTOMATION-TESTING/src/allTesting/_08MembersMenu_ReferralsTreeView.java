...
public class _08MembersMenu_ReferralsTreeView {
	...
	public void test() throws InterruptedException {
		...
		WebElement ReferralsTreeView = driver.findElement(By.linkText("Referrals Tree View"));
		action.moveToElement(ReferralsTreeView).click().perform();
